...
public class Matrix3x3 : MonoBehaviour, AnswerInput
{
    ...
    [SerializeField] TMP_InputField i3_2;
    [SerializeField] TMP_InputField i3_3;

    public string GetInput()
    {
        return "[" + i1_1.text + "," + i1_2.text + "," + i1_3.text + "]" + "[" + i2_1.text + "," + i2_2.text + "," + i2_3.text + "]" + "[" + i3_1.text + "," + i3_2.text + "," + i3_3.text + "]";
    }
